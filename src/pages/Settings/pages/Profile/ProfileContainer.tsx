...
export const ProfileContainer = () => {
  ...
  const userDetails: UserDetails = {
    ...
    agencyOfPresentPosting:updatedUser?.agencyOfPresentPosting?.nameOfSchool ?? userSaved?.user?.agencyOfPresentPosting?.nameOfSchool,
    agencyOfPreviousPosting:updatedUser?.agencyOfPreviousPosting?.nameOfSchool ?? userSaved?.user?.agencyOfPreviousPosting?.nameOfSchool,
